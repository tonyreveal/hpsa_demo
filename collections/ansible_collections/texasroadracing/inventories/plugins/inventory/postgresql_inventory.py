...
DOCUMENTATION = r"""
    name: texasroadracing.inventories.postgresql_inventory
    ...
    options:
        plugin:
            ...
            required: True
            choices: ['texasroadracing.inventories.postgresql_inventory']
        connection:
...
class InventoryModule(BaseInventoryPlugin):
    ...
    def verify_file(self, path):
        ...
        display.debug(
            "texasroadracing.inventories.postgresql_inventory inventory filename must end with 'pginv.yml' or 'pginv.yaml'"
        )
        return False
